...
#     modelo_lower = modelo_original.lower()
    
#     if marca_upper in modelos_por_marca:
#         # Buscar coincidencias parciales
#         for modelo_estandar in modelos_por_marca[marca_upper]:
#             # Si el modelo estándar está contenido en el modelo original
#             if modelo_estandar in modelo_lower:
#                 return modelo_estandar
    
#     # Si no hay coincidencia, devolver el modelo original
